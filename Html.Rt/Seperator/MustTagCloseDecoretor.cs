...
namespace Html.Rt.Seperator
{
     public class MustTagCloseDecorator : SeperatorDecorator
    {
        ...
        public override ParseResult Parse(HtmlContent content)
        {
        ...
        private IEnumerable<IHtmlMarkup> Decorate(IEnumerable<IHtmlMarkup> source,HtmlContent content)
        {
        ...
        private static IEnumerable<IHtmlMarkup> FoundEndTag(IHtmlElement isTag,IEnumerator<IHtmlMarkup> enumerator,HtmlContent htmlContent)
        {
